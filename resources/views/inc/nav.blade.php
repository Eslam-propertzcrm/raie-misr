@php $lang_nav = 'inc/nav.'; @endphp
            ...
            <div class="topbar">
                <div class="container">
                    ...
                    <div class="social-btns1">
                        <!-- <span>FOLLOW US</span> -->
                        <a href="#" title="Facebook" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-19.png') }}"></a>
                        <a href="#" title="Facebook" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-20.png') }}"></a>
                        <a href="#" title="Facebook" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-21.png') }}"></a>
                        <a href="#" title="Facebook" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-22.png') }}"></a>
                        <a href="#" title="Linkedin" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-23.png') }}"></a>
                        <a href="#" title="Twitter" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-24.png') }}"></a>
                        <a href="#" title="Google Plus" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-25.png') }}"></a>
                    </div>
                </div>
            </div>
            <div class="menu-wrapper">
                <div class="container">
                    <div class="menu-inner">
                        <div class="logo"><a href="../falah/index.html" title="Logo"><img style="height: 115px;" src="{{ asset('images/logo.png') }}" alt="logo.png"></a></div>
                        <nav>
                            <div class="">
                                <ul>
                                    ...
                                    <li class="menu-item-has-children"><a href="#" title="">التبرعات</a>
                                        <ul>
                                            <li class="menu-item-has-children"><a href="#" title="">سسسسسسسس</a>
                                                <ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="#" title="">سسسسسسسسسسس</a>
                                                <ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="#" title="">سسسسسسسسسسسس</a>
                                                <ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="#" title="">يييييييييييي</a>
                                                <ul>
                                            ...
                                            <li class="menu-item-has-children"><a href="#" title="">ششششششششششششش</a>
                                                <ul>
                                ...
                                <a href="../falah/donation-form.html" title="" class="header-donate"><i class="fa fa-money"></i> DONATE</a> -->
                            </div>
                        </nav>
                    </div>
                </div>
        ...
        <div class="res-header">
            <div class="res-header-top">
                <div class="res-top-links">
                    <div class="social-btns1">
                        <!-- <span>FOLLOW US</span> -->
                        <a href="#" title="Facebook" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-19.png') }}"></a>
                        <a href="#" title="Twitter" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-20.png') }}"></a>
                        <a href="#" title="Linkedin" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-21.png') }}"></a>
                        <a href="#" title="Youtub" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-22.png') }}"></a>
                        <a href="#" title="Instagram" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-23.png') }}"></a>
                        <a href="#" title="Apple" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-24.png') }}"></a>
                        <a href="#" title="Google Play" data-toggle="tooltip" data-placement="bottom" target="_blank"><img src="{{ asset('images/socials/web-25.png') }}"></a>
                    </div>
            ...
            <div class="res-logo-sec">
                <div class="logo"><a href="../falah/index.html" title=""><img src="{{ asset('images/logo2.png') }}" alt=""></a></div>
